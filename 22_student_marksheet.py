...
while bool_choice != False :
	...
	if float_percentage >= 85.0 and float_percentage <= 100.0 :
		char_grade = "A+"
	elif float_percentage < 85.0 and float_percentage >= 75.0 :
		char_grade = "A"
	elif float_percentage < 75.0 and float_percentage >= 60.0 :
		char_grade = "B"
	elif float_percentage <= 50  and float_percentage > 60 :
		char_grade = "C"
	elif float_percentage <= 40 and float_percentage < 50 :
		char_grade = "D"
	else:
		char_garde = "F"
